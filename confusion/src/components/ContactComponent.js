...
import { Breadcrumb, BreadcrumbItem, Button, Form, FormGroup, Label, FormFeedback, Input, Col } from 'reactstrap';
...
class Contact extends Component {
    ...
    handleSubmit(event) {
        console.log("Current Stateis: " + JSON.stringify(this.state));
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="tel" id="telnum" name="telnum" placeholder="Telephone No." value={this.state.telnum} valid={errors.telnum === ''} invalid={errors.telnum !== ''} onChange={this.handleInputChange} onBlur={this.handleBlur("telnum")}/>
